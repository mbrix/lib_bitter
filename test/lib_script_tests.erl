...
scripts6() ->
 ...
 Tx = lib_parse:parse_tx(<<1,0,0,0,1,27,107,249,156,93,146,19,154,204,31,166,147,113,99,190,110,
...
%           81,90,146,184,135>>,
% Tx = lib_parse:parse_tx(<<1,0,0,0,1,75,17,244,24,94,108,27,186,151,25,79,33,56,199,50,55,6,8,236,
...
%	Tx = lib_parse:parse_tx(<<1,0,0,0,3,254,26,37,200,119,76,30,130,127,158,189,174,115,31,230,9,255,
...
scripts9() ->
    ...
    Tx = lib_parse:parse_tx(<<1,0,0,0,1,217,166,180,219,47,73,40,237,23,44,34,200,162,171,148,31,2,98,
...
%	ScriptPubKey = <<"¥">>,
%	Tx = lib_parse:parse_tx(<<1,0,0,0,5,96,224,181,6,27,8,166,9,17,201,178,112,44,192,235,168,10,219,
